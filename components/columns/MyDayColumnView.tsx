...
interface MyDayColumnViewProps {
  ...
  onGoogleRepositionEnd: (id: string, startTime: string, endTime: string) => void;
  timedTasks: Array<{
    id: string;
    status: string;
    title: string;
            ...
            {googleEntries.map((entry) => {
              ...
              return (
                <CalendarEntryBlock
                  ...
                  onResizeEnd={onGoogleResizeEnd}
                  onRepositionEnd={onGoogleRepositionEnd}
                />
              );
            })}
